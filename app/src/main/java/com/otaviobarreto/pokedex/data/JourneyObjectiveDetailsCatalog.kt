...
object JourneyObjectiveDetailsCatalog {
    ...
    private val details=mapOf(
        ...
        "za-35" to d("A promoção ao Rank A inclui a investigação de Grisham, batalha com Emma, confronto com Griselle, exploração de Lysandre Labs e o Promotion Match final.",listOf(p("Emma","Nv. 57–58","Ampharos · Mawile · Lopunny · Lucario · Malamar"),p("Griselle","Nv. 59–61","Talonflame · Camerupt · Aerodactyl · Metagross · Mega Pyroar"),p("Grisham","Nv. 61–63","Pangoro · Malamar · Pyroar · Tyranitar · Salamence · Mega Charizard X")),listOf("Fada","Terra","Fogo"),"Preserve recursos nas lutas preparatórias. Contra Grisham, Fada cobre Pangoro/Malamar/Salamence e Terra ajuda contra Pyroar, Tyranitar e Mega Charizard X.","Promoção para Rank A."),
