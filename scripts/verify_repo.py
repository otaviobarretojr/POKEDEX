...
if "21306" not in workflow or "20.13.6" not in workflow:
    violations.append("CI v20.13.6 version validation missing")
...
if "Estado atual — v20.13.6" not in readme_v1810:
    violations.append("README current version is not v20.13.6")
