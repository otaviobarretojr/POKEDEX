...
object JourneyObjectiveDetailsCatalog {
    ...
    private val details=mapOf(
        "frlg-g1" to d("Brock usa Pedra/Terra em Pewter.",listOf(p("Geodude","Nv. 12","Pedra/Terra"),p("Onix","Nv. 14","Pedra/Terra")),listOf("Água","Planta","Lutador"),"Bulbasaur e Squirtle têm vantagem natural; Charmander deve buscar apoio cedo.","Boulder Badge."),
        "frlg-g2" to d("Misty usa Água e Starmie é a principal ameaça.",listOf(p("Staryu","Nv. 18","Água"),p("Starmie","Nv. 21","Água/Psíquico")),listOf("Elétrico","Planta"),"Pikachu ou Planta tornam a luta mais segura.","Cascade Badge."),
        "frlg-g3" to d("Lt. Surge usa Elétrico em Vermilion.",listOf(p("Voltorb","Nv. 21"),p("Pikachu","Nv. 18"),p("Raichu","Nv. 24")),listOf("Terra"),"Terra neutraliza a maior parte do ginásio.","Thunder Badge."),
        "frlg-g4" to d("Erika usa Planta/Veneno.",listOf(p("Victreebel","Nv. 29"),p("Tangela","Nv. 24"),p("Vileplume","Nv. 29")),listOf("Fogo","Voador","Psíquico","Gelo"),"Fogo/Voador/Psíquico são respostas excelentes.","Rainbow Badge."),
        "frlg-g5" to d("Koga usa Veneno e status.",listOf(p("Koffing","Nv. 37"),p("Muk","Nv. 39"),p("Koffing","Nv. 37"),p("Weezing","Nv. 43")),listOf("Psíquico","Terra"),"Psíquico é a resposta principal; leve cura para status.","Soul Badge."),
        "frlg-g6" to d("Sabrina pressiona com alto dano especial.",listOf(p("Kadabra","Nv. 38"),p("Mr. Mime","Nv. 37"),p("Venomoth","Nv. 38"),p("Alakazam","Nv. 43")),listOf("Fantasma","Inseto","Dano físico"),"Use atacantes físicos ou Fantasma/Inseto para evitar guerra especial.","Marsh Badge."),
        "frlg-g7" to d("Blaine usa Fogo em Cinnabar.",listOf(p("Growlithe","Nv. 42"),p("Ponyta","Nv. 40"),p("Rapidash","Nv. 42"),p("Arcanine","Nv. 47")),listOf("Água","Terra","Pedra"),"Água é a solução mais consistente.","Volcano Badge."),
        "frlg-g8" to d("Giovanni volta como líder de Viridian e fecha o arco da Team Rocket em Kanto.",listOf(p("Rhyhorn","Nv. 45"),p("Dugtrio","Nv. 42"),p("Nidoqueen","Nv. 44"),p("Nidoking","Nv. 45"),p("Rhyhorn","Nv. 50")),listOf("Água","Planta","Gelo","Psíquico"),"Água e Planta cobrem quase toda a equipe.","Earth Badge."),
        "frlg-pg-07" to d("Mewtwo aguarda no fundo de Cerulean Cave após a quest Ruby/Sapphire.",listOf(p("Mewtwo","Nv. 70","Psíquico")),listOf("Fantasma","Inseto","Sombrio"),"Reduza HP com cuidado e use status para captura.","Mewtwo."),
        "frlg-pg-08" to d("O lendário roaming depende do inicial escolhido.",listOf(p("Entei / Suicune / Raikou","Nv. 50","Bulbasaur → Entei · Charmander → Suicune · Squirtle → Raikou")),listOf("Captura","Trapping","Status"),"O roaming foge rapidamente; tracking e trapping são mais importantes que dano bruto.","Lendário roaming de Kanto."),
        "frlg-pg-09" to d("A segunda Liga usa equipes fortalecidas e alguns Pokémon de Johto.",listOf(p("Elite Four rematch","Nv. 63–75","Equipes atualizadas"),p("Champion rival","Nv. 72–75","Equipe atualizada")),listOf("Cobertura ampla"),"É um endgame de batalha real; preserve PP e itens para a sequência completa.","Conclusão do principal conteúdo de batalha pós-game."),
        "lgpe-g1" to d("Brock abre a rota de ginásios com uma equipe de Pedra.",listOf(p("Geodude","Nv. 11","Pedra/Terra"),p("Onix","Nv. 12","Pedra/Terra")),listOf("Água","Planta","Lutador"),"Partner Pikachu precisa de apoio; Partner Eevee pode usar cobertura, mas Água/Planta/Lutador são mais diretos.","Boulder Badge."),
        "lgpe-g2" to d("Misty usa Água e fecha com Starmie.",listOf(p("Psyduck","Nv. 18","Água"),p("Starmie","Nv. 19","Água/Psíquico")),listOf("Elétrico","Planta"),"Pikachu tem vantagem natural; Eevee deve recorrer à cobertura exclusiva ou a um parceiro adequado.","Cascade Badge."),
        "lgpe-g3" to d("Lt. Surge usa Elétrico em Vermilion.",listOf(p("Voltorb","Nv. 25","Elétrico"),p("Magnemite","Nv. 25","Elétrico/Aço"),p("Raichu","Nv. 26","Elétrico")),listOf("Terra"),"Um Pokémon de Terra simplifica quase toda a luta.","Thunder Badge."),
        "lgpe-g4" to d("Erika é especialista em Planta.",listOf(p("Tangela","Nv. 33","Planta"),p("Weepinbell","Nv. 33","Planta/Veneno"),p("Vileplume","Nv. 34","Planta/Veneno")),listOf("Fogo","Voador","Psíquico","Gelo"),"Fogo/Voador resolvem a maior parte do ginásio.","Rainbow Badge."),
        "lgpe-g5" to d("Koga usa Veneno e status em Fuchsia.",listOf(p("Weezing","Nv. 43","Veneno"),p("Muk","Nv. 43","Veneno"),p("Golbat","Nv. 43","Veneno/Voador"),p("Venomoth","Nv. 44","Inseto/Veneno")),listOf("Psíquico","Terra"),"Psíquico é a resposta principal; leve cura para status.","Soul Badge."),
        "lgpe-g6" to d("Sabrina possui uma das equipes mais fortes entre os ginásios de Kanto.",listOf(p("Mr. Mime","Nv. 43","Psíquico/Fada"),p("Slowbro","Nv. 43","Água/Psíquico"),p("Jynx","Nv. 43","Gelo/Psíquico"),p("Alakazam","Nv. 44","Psíquico")),listOf("Fantasma","Inseto","Sombrio"),"Priorize dano físico e cobertura Fantasma/Inseto para reduzir sua pressão especial.","Marsh Badge."),
        "lgpe-g7" to d("Blaine usa Fogo em Cinnabar.",listOf(p("Magmar","Nv. 47","Fogo"),p("Rapidash","Nv. 47","Fogo"),p("Ninetales","Nv. 47","Fogo"),p("Arcanine","Nv. 48","Fogo")),listOf("Água","Terra","Pedra"),"Água é a rota mais simples e consistente.","Volcano Badge."),
        "lgpe-g8" to d("Giovanni retorna como líder de Viridian e encerra o arco da Team Rocket.",listOf(p("Dugtrio","Nv. 49","Terra"),p("Nidoqueen","Nv. 49","Veneno/Terra"),p("Nidoking","Nv. 49","Veneno/Terra"),p("Rhydon","Nv. 50","Terra/Pedra")),listOf("Água","Planta","Gelo","Psíquico"),"Água e Planta cobrem grande parte da equipe; Gelo/Psíquico ajudam contra combinações secundárias.","Earth Badge."),
        "lgpe-e4-1" to d("Lorelei mistura Gelo e Água.",listOf(p("Dewgong","Nv. 51"),p("Jynx","Nv. 51"),p("Cloyster","Nv. 51"),p("Slowbro","Nv. 51"),p("Lapras","Nv. 52")),listOf("Elétrico","Planta","Pedra","Lutador"),"Elétrico tem ótimo valor, mas cuidado com coberturas de Gelo.","Avanço na Elite Four."),
        "lgpe-e4-2" to d("Bruno mistura Lutadores com Onix.",listOf(p("Onix","Nv. 52"),p("Hitmonchan","Nv. 52"),p("Hitmonlee","Nv. 52"),p("Poliwrath","Nv. 52"),p("Machamp","Nv. 53")),listOf("Psíquico","Voador","Água","Planta"),"Psíquico/Voador cobrem Lutadores; Água/Planta lidam com Onix.","Avanço na Elite Four."),
        "lgpe-e4-3" to d("Agatha usa principalmente Fantasma e Veneno.",listOf(p("Arbok","Nv. 53"),p("Gengar","Nv. 53"),p("Golbat","Nv. 53"),p("Weezing","Nv. 53"),p("Gengar","Nv. 54")),listOf("Psíquico","Terra","Fantasma"),"Psíquico/Terra são muito eficientes contra a base Veneno.","Avanço na Elite Four."),
        "lgpe-e4-4" to d("Lance fecha a Elite Four com Dragões e voadores poderosos.",listOf(p("Seadra","Nv. 54"),p("Aerodactyl","Nv. 54"),p("Gyarados","Nv. 54"),p("Charizard","Nv. 54"),p("Dragonite","Nv. 55")),listOf("Gelo","Elétrico","Pedra"),"Gelo é a resposta-chave para Dragonite; Elétrico/Pedra ajudam contra os voadores.","Acesso ao Champion."),
        "lgpe-22" to d("Trace é o campeão final da primeira campanha.",listOf(p("Pidgeot","Nv. 56"),p("Vileplume / Marowak","Nv. 56","Depende da versão"),p("Rapidash","Nv. 56"),p("Slowbro","Nv. 56"),p("Jolteon / Raichu","Nv. 57","Parceiro evoluído do rival")),listOf("Cobertura ampla"),"Entre com seis membros fortes e um plano para a composição da sua versão.","Título de Champion de Kanto."),
        "lgpe-pg-01" to d("Mewtwo espera no fundo de Cerulean Cave após a Liga.",listOf(p("Mewtwo","Nv. 70","Psíquico")),listOf("Fantasma","Inseto","Sombrio"),"A batalha tem limite de tempo antes da fase de captura; priorize dano rápido e leve boas Berries/Poké Balls.","Mewtwo."),
        "lgpe-pg-02" to d("Green aparece em Cerulean Cave depois que Mewtwo é capturado.",listOf(p("Green","Nv. 66–68","Equipe completa")),listOf("Cobertura ampla"),"Leve uma equipe equilibrada; é um duelo de pós-game, não uma batalha de captura.","Vitória sobre Green."),
        "lgpe-pg-04" to d("Red surge como superboss após você derrotar pelo menos 6 Master Trainers.",listOf(p("Red","Nv. 85","Equipe completa · sem itens")),listOf("Cobertura ampla"),"Leve 6 Pokémon fortes. Itens da bolsa não são permitidos durante a luta.","Título de Battle Master após derrotar Red."),
        "lgpe-pg-05" to d("Blue assume o Viridian Gym após Giovanni deixar o posto.",listOf(p("Blue","Nv. 66–68","Novo líder de Viridian")),listOf("Cobertura ampla"),"A equipe de Blue é variada; trate como uma batalha de endgame.","Vitória sobre Blue no Viridian Gym."),
        "swsh-g1" to d("Milo abre o Gym Challenge com uma equipe Planta e Dynamax no encerramento.",listOf(p("Gossifleur","Nv. 19","Planta"),p("Eldegoss","Nv. 20","Planta · Dynamax")),listOf("Fogo","Voador","Inseto","Gelo"),"Guarde Dynamax para Eldegoss e pressione com vantagem de tipo.","Grass Badge."),
        "swsh-g2" to d("Nessa usa Água e termina com Drednaw em Dynamax.",listOf(p("Goldeen","Nv. 22","Água"),p("Arrokuda","Nv. 23","Água"),p("Drednaw","Nv. 24","Água/Pedra · Dynamax")),listOf("Elétrico","Planta"),"Planta é especialmente forte contra Drednaw por sua combinação Água/Pedra.","Water Badge."),
        "swsh-g3" to d("Kabu fecha o primeiro bloco de ginásios com Fogo e Gigantamax Centiskorch.",listOf(p("Ninetales","Nv. 25","Fogo"),p("Arcanine","Nv. 25","Fogo"),p("Centiskorch","Nv. 27","Fogo/Inseto · Gigantamax")),listOf("Água","Terra","Pedra"),"Evite Burn e responda ao Gigantamax com Água/Pedra/Terra.","Fire Badge."),
        "swsh-g4" to d("O quarto líder muda conforme a versão.",listOf(p("Bea","Nv. 34–36","Sword · Lutador"),p("Allister","Nv. 34–36","Shield · Fantasma")),listOf("Psíquico","Fada","Voador","Sombrio","Fantasma"),"Sword pede respostas para Lutador; Shield pede Sombrio/Fantasma.","Fighting Badge ou Ghost Badge."),
        "swsh-g5" to d("Opal usa Fada e incorpora perguntas durante a batalha.",listOf(p("Weezing","Nv. 36","Veneno/Fada"),p("Mawile","Nv. 36","Aço/Fada"),p("Togekiss","Nv. 37","Fada/Voador"),p("Alcremie","Nv. 38","Fada · Gigantamax")),listOf("Aço","Veneno"),"Respostas do quiz podem alterar stats; não dependa apenas disso e leve cobertura Aço/Veneno.","Fairy Badge."),
        "swsh-g6" to d("O sexto líder também é exclusivo por versão.",listOf(p("Gordie","Nv. 40–42","Sword · Pedra"),p("Melony","Nv. 40–42","Shield · Gelo")),listOf("Água","Planta","Terra","Lutador","Aço","Fogo"),"Ajuste a equipe à sua versão antes de entrar no estádio.","Rock Badge ou Ice Badge."),
        "swsh-g7" to d("Piers é especialista Sombrio e não utiliza Dynamax.",listOf(p("Scrafty","Nv. 44","Sombrio/Lutador"),p("Malamar","Nv. 45","Sombrio/Psíquico"),p("Skuntank","Nv. 45","Veneno/Sombrio"),p("Obstagoon","Nv. 46","Sombrio/Normal")),listOf("Lutador","Fada","Inseto"),"Sem Dynamax, trocas e cobertura normal decidem a luta.","Dark Badge."),
        "swsh-g8" to d("Raihan transforma o último ginásio em uma batalha dupla baseada em clima.",listOf(p("Gigalith","Nv. 46","Pedra"),p("Flygon","Nv. 47","Terra/Dragão"),p("Sandaconda","Nv. 46","Terra"),p("Duraludon","Nv. 48","Aço/Dragão · Gigantamax")),listOf("Fada","Gelo","Lutador","Terra"),"Controle Sandstorm e pense em sinergia de dupla, não apenas em fraqueza Dragão.","Dragon Badge."),
        "swsh-13" to d("As semifinais da Champion Cup colocam você contra os rivais antes da chave final.",listOf(p("Marnie","Nv. 47–49","Semifinalista"),p("Hop","Nv. 48–49","Semifinalista")),listOf("Cobertura ampla"),"Use seu time principal e preserve recursos para as finais.","Classificação para a fase final da Champion Cup."),
        "swsh-14" to d("As finais da Champion Cup reúnem Bede e líderes de ginásio antes do Champion Match.",listOf(p("Bede","Nv. 51–53","Fada"),p("Finalistas","Nv. 52–55","Líderes conforme a chave/versão")),listOf("Cobertura ampla"),"Planeje a chave como uma sequência de batalhas e não gaste todos os recursos em um único confronto.","Acesso ao Champion Match."),
        "swsh-15" to d("O Darkest Day culmina no confronto com Eternatus e Eternamax Eternatus.",listOf(p("Eternatus","Nv. 60","Veneno/Dragão"),p("Eternamax Eternatus","Nv. 60","Batalha especial")),listOf("Terra","Psíquico","Gelo","Dragão"),"Na fase especial, Zacian e Zamazenta participam do confronto.","Conclusão da crise do Darkest Day."),
        "swsh-16" to d("Leon é o campeão de Galar e possui uma equipe que varia parcialmente com o inicial.",listOf(p("Aegislash","Nv. 62","Aço/Fantasma"),p("Dragapult","Nv. 62","Dragão/Fantasma"),p("Haxorus","Nv. 63","Dragão"),p("Charizard","Nv. 65","Fogo/Voador · Gigantamax")),listOf("Pedra","Elétrico","Fada","Sombrio","Terra"),"Garanta uma resposta ao Gigantamax Charizard e preserve cobertura para o restante da equipe.","Título de Champion de Galar."),
        "swsh-pg-02" to d("O episódio de Sordward e Shielbert termina com o lendário da sua versão.",listOf(p("Zacian","Nv. 70","Sword · Fada/Aço"),p("Zamazenta","Nv. 70","Shield · Lutador/Aço")),listOf("Terra","Fogo"),"Reduza HP com segurança e prepare a captura do lendário correspondente.","Zacian ou Zamazenta."),
        "swsh-ioa-04" to d("Kubfu enfrenta sozinho a Tower of Two Fists.",listOf(p("Kubfu","Treinado pelo jogador","Único Pokémon permitido"),p("Mustard","≈ Nv. 70","Chefe da torre")),listOf("Treinamento de Kubfu","Cura"),"Tower of Darkness gera Single Strike Urshifu; Tower of Waters gera Rapid Strike Urshifu.","Evolução de Kubfu para Urshifu."),
        "swsh-ct-02" to d("A primeira Legendary Clue gira em torno de Calyrex e seu corcel.",listOf(p("Calyrex","Nv. 80","Psíquico/Planta"),p("Glastrier / Spectrier","Nv. 75","Escolha de rota")),listOf("Sombrio","Fantasma","Captura"),"A escolha do campo determina o corcel e a forma Ice Rider ou Shadow Rider.","Calyrex e seu corcel."),
        "swsh-ct-03" to d("Os templos dos Regis exigem puzzles antes das capturas.",listOf(p("Regirock","Nv. 70","Pedra"),p("Regice","Nv. 70","Gelo"),p("Registeel","Nv. 70","Aço"),p("Regieleki / Regidrago","Nv. 70","Escolha exclusiva")),listOf("Lutador","Terra","Fogo"),"A escolha final entre Regieleki e Regidrago não pode ser desfeita no mesmo save.","Legendary Giants."),
        "swsh-ct-04" to d("As aves lendárias de Galar fogem para três regiões diferentes.",listOf(p("Galarian Articuno","Nv. 70","Psíquico/Voador"),p("Galarian Zapdos","Nv. 70","Lutador/Voador"),p("Galarian Moltres","Nv. 70","Sombrio/Voador")),listOf("Elétrico","Gelo","Pedra","Fada"),"Localize cada ave na região correspondente antes de iniciar a captura.","Galarian Legendary Birds."),
        "swsh-ct-05" to d("Dynamax Adventures usam uma equipe temporária de Pokémon de aluguel no Max Lair.",listOf(p("Lendário final","Nv. 70","Varia por rota")),listOf("Leitura de rota","Cooperação"),"Escolha Pokémon de aluguel pela cobertura necessária e administre as quatro vidas compartilhadas.","Acesso a diversos lendários e progressão do Max Lair."),
        "la-07" to d("Kleavor é o primeiro Nobre frenético de Hisui. O combate alterna esquiva, balms e uma janela opcional de batalha Pokémon.",listOf(p("Kleavor","Nv. 18","Pedra / Inseto · Nobre")),listOf("Água","Pedra","Aço"),"Priorize aprender o padrão de investida e arremesse balms após cada esquiva segura.","Insect Plate e avanço da história dos Nobres."),
        "la-08" to d("Hisuian Lilligant é a Lady of the Ridge e usa um padrão de dança com ondas de choque.",listOf(p("Hisuian Lilligant","Nv. 30","Planta / Lutador · Nobre")),listOf("Fogo","Voador","Psíquico","Gelo","Fada"),"Esquive no ritmo dos pulsos e use a fase de batalha apenas para acelerar a barra de frenzy.","Meadow Plate e progressão da Crimson Mirelands."),
        "la-10" to d("Hisuian Arcanine assume o papel de Lord of the Isles em Firespit Island.",listOf(p("Hisuian Arcanine","Nv. 36","Fogo / Pedra · Nobre")),listOf("Água","Terra","Lutador","Pedra"),"A arena limita a movimentação. Não se prenda entre as chamas e use Água/Terra quando surgir a janela de batalha.","Flame Plate e conclusão do arco principal da Cobalt Coastlands."),
        "la-11" to d("Hisuian Electrode é o Lord of the Hollow e mantém projéteis perseguindo o jogador durante boa parte do encontro.",listOf(p("Hisuian Electrode","Nv. 46","Elétrico / Planta · Nobre")),listOf("Fogo","Gelo","Veneno","Inseto"),"Continue em movimento e não force arremessos quando os projéteis estiverem fechando sua rota de fuga.","Zap Plate e avanço para a fase final de Hisui."),
        "la-12" to d("Hisuian Avalugg é o último Nobre frenético da campanha principal e funciona como um chefe de padrão à distância.",listOf(p("Hisuian Avalugg","Nv. 56","Gelo / Pedra · Nobre")),listOf("Lutador","Aço","Água","Planta","Terra"),"Leia as sequências de projéteis antes de atacar; as janelas de balm valem mais que trocar dano.","Icicle Plate e fechamento do arco dos cinco Nobres."),
        "la-17" to d("Atop Mount Coronet inicia a sequência final da crise do espaço-tempo.",listOf(p("Commander Kamado","≈ Nv. 60+","Batalha de história"),p("Lendário do tempo/espaço","Nv. 65","Dialga ou Palkia conforme a rota")),listOf("Cobertura ampla","Dragão","Fada","Gelo"),"Entre com os seis membros curados e economize Revives para a sequência.","Acesso ao fechamento da campanha no Temple of Sinnoh."),
        "la-18" to d("The Counterpart fecha a campanha principal com o segundo lendário do espaço-tempo.",listOf(p("Dialga / Palkia","Nv. 65","Forma originária conforme a rota")),listOf("Dragão","Fada"),"Use uma equipe resistente e preserve recursos de captura; o objetivo é concluir a crise, não só causar dano.","Créditos e acesso ao pós-game."),
        "la-21" to d("A busca das Plates leva de volta aos três guardiões dos lagos.",listOf(p("Mesprit","Nv. 70"),p("Azelf","Nv. 70"),p("Uxie","Nv. 70")),listOf("Sombrio","Fantasma","Inseto"),"Controle o HP e use status; os três encontros fazem parte da coleção de lendários necessária ao pós-game.","Plates ligadas aos lagos e avanço da missão de Volo."),
        "la-22" to d("Heatran guarda a Plate em Firespit Island.",listOf(p("Heatran","Nv. 70","Fogo / Aço")),listOf("Terra","Água","Lutador"),"Terra causa dano muito alto; reduza o ritmo se estiver preparando a captura.","Plate de Firespit Island."),
        "la-23" to d("Cresselia aparece em Moonview Arena durante a coleta das Plates.",listOf(p("Cresselia","Nv. 70","Psíquico")),listOf("Sombrio","Fantasma","Inseto"),"Use dano controlado e status para lidar com sua durabilidade.","Plate de Moonview Arena."),
        "la-24" to d("Regigigas desperta em Snowpoint Temple durante a rota das Plates.",listOf(p("Regigigas","Nv. 70","Normal")),listOf("Lutador"),"Lutador é a resposta direta; mantenha HP suficiente para a captura após enfraquecê-lo.","Plate de Snowpoint Temple."),
        "la-26" to d("Volo revela seu objetivo e conduz a uma das batalhas mais longas do jogo, seguida por Giratina.",listOf(p("Volo","Nv. 68","Equipe completa"),p("Giratina","Nv. 70","Duas formas em sequência")),listOf("Fada","Gelo","Sombrio","Fantasma"),"Trate a luta como três fases: Volo, Giratina Altered e Giratina Origin. Preserve PP e itens para o fim.","Spooky Plate, Azure Flute e avanço para Arceus."),
        "la-27" to d("Após cumprir o requisito de espécies da Pokédex, o Azure Flute abre o encontro final com Arceus.",listOf(p("Arceus","Nv. 75","Chefe final")),listOf("Mecânica de balms","Sobrevivência"),"O encontro é centrado em esquiva e balms. A batalha Pokémon aparece como ferramenta auxiliar, não como única solução.","Conclusão da missão The Deified Pokémon e encontro com Arceus."),
        "la-db-102" to d("Daybreak fecha a linha de pesquisa dos Massive Mass Outbreaks e expande o endgame de Hisui.",listOf(p("Massive Mass Outbreaks","Nv. variável","Eventos de área"),p("Desafios avançados","Pós-game","Training Grounds / Reverie")),listOf("Captura","Pesquisa","Mobilidade"),"Use montarias e itens de captura rápida; o tempo da tempestade é o principal recurso.","Libera/fecha a pesquisa de Massive Mass Outbreaks e conteúdos avançados de batalha."),
        "sv-01" to d(
        ...
        "za-35" to d("A promoção ao Rank A inclui a investigação de Grisham, batalha com Emma, confronto com Griselle, exploração de Lysandre Labs e o Promotion Match final.",listOf(p("Ampharos","Nv. 57","Emma"),p("Mawile","Nv. 57","Emma"),p("Lopunny","Nv. 57","Emma"),p("Lucario","Nv. 57","Emma"),p("Malamar","Nv. 58","Emma · Mega"),p("Talonflame","Nv. 59","Griselle"),p("Camerupt","Nv. 59","Griselle"),p("Aerodactyl","Nv. 60","Griselle"),p("Metagross","Nv. 60","Griselle"),p("Pyroar","Nv. 61","Griselle · Mega"),p("Pangoro","Nv. 61","Grisham"),p("Malamar","Nv. 61","Grisham"),p("Pyroar","Nv. 61","Grisham"),p("Tyranitar","Nv. 62","Grisham"),p("Salamence","Nv. 62","Grisham"),p("Charizard","Nv. 63","Grisham · Mega Charizard X")),listOf("Fada","Terra","Fogo"),"Preserve recursos nas lutas preparatórias. Contra Grisham, Fada cobre Pangoro/Malamar/Salamence e Terra ajuda contra Pyroar, Tyranitar e Mega Charizard X.","Promoção para Rank A."),
