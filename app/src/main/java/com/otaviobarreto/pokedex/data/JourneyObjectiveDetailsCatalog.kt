...
object JourneyObjectiveDetailsCatalog {
    ...
    private val details=mapOf(
        ...
        "za-35" to d("Grisham é o último Promotion Match antes do Rank A.",listOf(p("Pangoro","Nv. 61"),p("Malamar","Nv. 61"),p("Pyroar","Nv. 61"),p("Tyranitar","Nv. 62"),p("Salamence","Nv. 62"),p("Charizard","Nv. 63","Mega Charizard X")),listOf("Fada","Terra"),"Fada resolve Pangoro/Malamar/Salamence; Terra ajuda contra Pyroar, Tyranitar e Mega Charizard X.","Promoção para Rank A e TM Flare Blitz."),
