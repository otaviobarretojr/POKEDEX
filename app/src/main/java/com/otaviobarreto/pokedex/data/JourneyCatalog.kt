...
object JourneyCatalog {
    ...
    private val swordShield = listOf(
        ...
        JourneyStep("swsh-13",13,"Champion Cup Semifinals","Semifinais em Wyndon","Nv. 49–53",JourneyChallengeKind.STORY,"Champion Cup","Wyndon Stadium","A reta final começa com as semifinais contra os rivais."),
        JourneyStep("swsh-14",14,"Darkest Day","Rose, Eternatus e Eternamax Eternatus","Nv. 55–60",JourneyChallengeKind.STORY,"Darkest Day","Hammerlocke / Energy Plant","A crise interrompe o torneio antes da batalha final pelo título."),
        JourneyStep("swsh-15",15,"Champion Leon","Final do Champion Cup","Nv. 62–65",JourneyChallengeKind.STORY,"Campeão","Wyndon Stadium","Leon encerra a campanha principal de Galar."),
