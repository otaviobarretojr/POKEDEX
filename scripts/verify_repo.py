...
if "10501" not in workflow or "10.5.0" not in workflow:
...
for required in ("PACK_VERSION = 10", "cachedImages", "expectedImages", "hasOfflineArtwork", 'openSnapshot("pokemon-offline-$id")'):
