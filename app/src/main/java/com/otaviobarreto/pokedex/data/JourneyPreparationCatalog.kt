...
object JourneyPreparationCatalog {
    ...
    private val items=mapOf(
        ...
        "la-daybreak" to JourneyPreparation("la-daybreak","65+",listOf("Captura","Pesquisa","Mobilidade"),listOf(899,901,902,903,904),listOf("Ultra Ball","Jet Ball","Sticky Glob"),"Massive Mass Outbreaks são cronometrados: priorize mobilidade, capturas rápidas e o objetivo de pesquisa antes da tempestade acabar."),
