                ...
                BoxWithConstraints(Modifier.fillMaxSize().graphicsLayer {
                    ...
                    Canvas(Modifier.fillMaxSize()) {
                        if (regionLabel == "Kitakami") {
                            drawKitakamiMap(size.width, size.height, surface, primary, secondary, tertiary, outline)
                        } else {
                            drawTerariumMap(size.width, size.height, surface, primary, secondary, tertiary, outline)
                        }
                    }
...
private fun androidx.compose.ui.graphics.drawscope.DrawScope.drawKitakamiMap(
    ...
    drawPath(barrens, tertiary.copy(alpha = .22f))
