...
checks={
    ...
    "update-safe version code": ('versionCode = 19200' in gradle) or ('versionCode = 20000' in gradle) or ('versionCode = 20300' in gradle) or ('versionCode = 20400' in gradle) or ('versionCode = 20500' in gradle) or ('versionCode = 20600' in gradle),
