...
object JourneyVisualAssetCatalog {
    ...
    private val assets=mapOf(
        ...
        "lgpe-pg-02" to JourneyVisualAsset("lgpe-pg-02",JourneyVisualRole.TOURNAMENT,"Green",ART+"9.png","Cerulean Cave · pós-game","Pokémon Let's Go Pikachu / Eevee"),
        "lgpe-pg-04" to JourneyVisualAsset("lgpe-pg-04",JourneyVisualRole.TOURNAMENT,"Red",ART+"25.png","Master Trainer superboss","Pokémon Let's Go Pikachu / Eevee"),
        "lgpe-pg-05" to JourneyVisualAsset("lgpe-pg-05",JourneyVisualRole.GYM_LEADER,"Blue",ART+"18.png","Viridian Gym · pós-game","Pokémon Let's Go Pikachu / Eevee"),
        ...
        "bdsp-pg-02" to JourneyVisualAsset("bdsp-pg-02",JourneyVisualRole.LEGENDARY,"Lake Guardians",ART+"481.png","Uxie · Mesprit · Azelf","Pokémon Brilliant Diamond / Shining Pearl"),
        "bdsp-pg-03" to JourneyVisualAsset("bdsp-pg-03",JourneyVisualRole.LEGENDARY,"Ramanas Park",ART+"150.png","Lendários · pós-game","Pokémon Brilliant Diamond / Shining Pearl"),
        "bdsp-pg-04" to JourneyVisualAsset("bdsp-pg-04",JourneyVisualRole.LEGENDARY,"Cresselia",ART+"488.png","Fullmoon Island","Pokémon Brilliant Diamond / Shining Pearl"),
        "bdsp-pg-05" to JourneyVisualAsset("bdsp-pg-05",JourneyVisualRole.LEGENDARY,"Giratina",ART+"487.png","Turnback Cave","Pokémon Brilliant Diamond / Shining Pearl"),
        "bdsp-pg-06" to JourneyVisualAsset("bdsp-pg-06",JourneyVisualRole.LEGENDARY,"Regigigas",ART+"486.png","Snowpoint Temple","Pokémon Brilliant Diamond / Shining Pearl"),
        "bdsp-pg-08" to JourneyVisualAsset("bdsp-pg-08",JourneyVisualRole.LEGENDARY,"Heatran",ART+"485.png","Stark Mountain","Pokémon Brilliant Diamond / Shining Pearl"),
