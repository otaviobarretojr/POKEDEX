...
object JourneyObjectiveDetailsCatalog {
    ...
    private val details=mapOf(
        ...
        "swsh-13" to d("O Darkest Day culmina no confronto com Eternatus e Eternamax Eternatus.",listOf(p("Eternatus","Nv. 60","Veneno/Dragão"),p("Eternamax Eternatus","Nv. 60","Batalha especial")),listOf("Terra","Psíquico","Gelo","Dragão"),"Na fase especial, Zacian e Zamazenta participam do confronto.","Conclusão da crise do Darkest Day."),
