...
e com.otaviobarreto.pokedex.data
...
class LocationIntelligenceTest {
    ...
    @Test fun championsDoesNotExposeWildLocations() {
        val champions=GameContext.fromSource("Pokémon Champions · Roster")
        assertFalse(LocationIntelligence.isSupported(champions))
    }
}
