...
object JourneyObjectiveDetailsCatalog {
    ...
    private val details=mapOf(
        ...
        "lgpe-pg-03" to d("Red surge como superboss depois de provar domínio sobre os Master Trainers.",listOf(p("Red","Nv. 85","Equipe completa")),listOf("Cobertura ampla"),"É um desafio de endgame; use seu melhor time e candies se necessário.","Vitória sobre Red."),
