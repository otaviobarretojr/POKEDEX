...
object JourneyCatalog {
    ...
    private val legendsZa = listOf(
        ...
        JourneyStep("za-09",9,"Chase the Mysterious Pokemon","Absol e o mistério de Lumiose","Nv. 24–25",JourneyChallengeKind.STORY,"História","Lumiose City"),
        ...
        JourneyStep("za-dlc-08",51,"Hyperspace Lumiose Survey No. 4","Survey de 4 estrelas","Nv. 150+",JourneyChallengeKind.DLC,"Hyperspace","Hyperspace Lumiose"),
        JourneyStep("za-dlc-09",52,"Hyperspace Lumiose Survey No. 5","28.000 pontos","Nv. 160+",JourneyChallengeKind.DLC,"Hyperspace","Hyperspace Lumiose"),
        JourneyStep("za-dlc-10",53,"Mayhem at Midnight","Crise no Hotel Z","Nv. 170+",JourneyChallengeKind.DLC,"História","Hotel Z"),
        JourneyStep("za-dlc-11",54,"Hyperspace Lumiose Survey No. 6","50.000 pontos + clímax do Hyperspace","Nv. 180+",JourneyChallengeKind.DLC,"Hyperspace","Hyperspace Lumiose"),
